...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Cel mai mare numar este " + op.getHigherNumber(1, 2));
        System.out.println(op.checkText("bla bla"));
        System.out.println(op.checkTextnNumber("FastTrackIT", 3));
        System.out.println(op.snow(7));
